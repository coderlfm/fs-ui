...
import { Form as Form$1, Col, Space, Button, Select, DatePicker, Input, TimePicker, Tabs, Row, Grid, ConfigProvider, Table, message } from 'antd';
...
var Form = /*#__PURE__*/memo(function (props) {
  ...
  return /*#__PURE__*/React.createElement(Form$1, Object.assign({
    layout: "inline",
    form: form,
    name: "control-hooks",
    onFinish: onFinish
  ...
  }), (formProps === null || formProps === void 0 ? void 0 : formProps.search) && renderForm(formProps.search), /*#__PURE__*/React.createElement(Form$1.Item, Object.assign({}, tailLayout, {
    className: "form-footer"
  }), /*#__PURE__*/React.createElement(Space, null, /*#__PURE__*/React.createElement(Button, {
    htmlType: "button",
    onClick: onReset,
    className: "btn-default"
  }, (formProps === null || formProps === void 0 ? void 0 : (_formProps$config = formProps.config) === null || _formProps$config === void 0 ? void 0 : (_formProps$config$res = _formProps$config.reset) === null || _formProps$config$res === void 0 ? void 0 : _formProps$config$res.text) || '重置'), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    htmlType: "submit",
    ...
    return /*#__PURE__*/React.createElement(Button, Object.assign({}, item.btnProps, {
...
var renderForm = function renderForm(search) {
  ...
  var renderFormEle = function renderFormEle(type, searchProps) {
    ...
    switch (type) {
      case 'input':
        ele = /*#__PURE__*/React.createElement(Input, Object.assign({
          allowClear: true
        }, searchProps));
        break;

      case 'select':
        ele = /*#__PURE__*/React.createElement(Select, Object.assign({
          allowClear: true
      ...
      case 'rangepicker':
        ele = /*#__PURE__*/React.createElement(RangePicker, Object.assign({
          allowClear: true
        }, searchProps));
        break;

      case 'timepicker ':
        ele = /*#__PURE__*/React.createElement(TimePicker, Object.assign({
          allowClear: true
        }, searchProps));
        break;
  ...
  return search.map(function (item) {
    return /*#__PURE__*/React.createElement(Col, Object.assign({
      ...
      sm: 24,
      xl: 8
    }, item.wrap.col), /*#__PURE__*/React.createElement(Form$1.Item, Object.assign({
      colon: false
    }, item.wrap), renderFormEle(item.wrap.type, item.props)));
  });
};

var index = /*#__PURE__*/memo(function () {
  return /*#__PURE__*/React.createElement("div", null);
});

var TabPane = Tabs.TabPane;
var index$1 = /*#__PURE__*/memo(function () {
  return /*#__PURE__*/React.createElement("div", {
    ...
    tab: "Tab 1",
    key: "1"
  }, "Tab 1"), /*#__PURE__*/React.createElement(TabPane, {
    tab: "Tab 2",
    disabled: true,
    key: "2"
  }, "Tab 2"), /*#__PURE__*/React.createElement(TabPane, {
    tab: "Tab 3",
    key: "3"
  }, "Tab 3")));
});
...
var ProTableHeader = /*#__PURE__*/memo(function (props) {
  ...
  var _useState = useState((tabs === null || tabs === void 0 ? void 0 : (_tabs$secondTabs = tabs.secondTabs) === null || _tabs$secondTabs === void 0 ? void 0 : _tabs$secondTabs.defaultKey) || 1),
      _useState2 = _slicedToArray(_useState, 2),
      secondTab = _useState2[0],
      setSecondTab = _useState2[1]; // 二级菜单active


  var _useState3 = useState((tabs === null || tabs === void 0 ? void 0 : (_tabs$secondTabs2 = tabs.secondTabs) === null || _tabs$secondTabs2 === void 0 ? void 0 : _tabs$secondTabs2.defaultOpen) ? 0.5 : 0),
  ...
  var _useState7 = useState(_objectSpread2(_objectSpread2({}, colSettingDefault), tabs === null || tabs === void 0 ? void 0 : (_tabs$secondTabs3 = tabs.secondTabs) === null || _tabs$secondTabs3 === void 0 ? void 0 : _tabs$secondTabs3.col)),
  ...
  return /*#__PURE__*/React.createElement("header", {
  ...
  }, /*#__PURE__*/React.createElement("h2", null, title || ''), tabs && tabs.firstTabs && /*#__PURE__*/React.createElement("section", {
    className: "first"
  }, /*#__PURE__*/React.createElement(Tabs, {
  ...
  }))), tabs && tabs.secondTabs && /*#__PURE__*/React.createElement("section", {
    className: "second"
  }, /*#__PURE__*/React.createElement("span", null, tabs.secondTabs.title, "\uFF1A"), /*#__PURE__*/React.createElement(Row, {
    ...
    if (rotate) {
      return /*#__PURE__*/React.createElement(Col, Object.assign({
        key: item.key
      }, colSetting), /*#__PURE__*/React.createElement(Button, {
  ...
  }, rotate ? '收起' : '展开', /*#__PURE__*/React.createElement(DownOutlined, {
    style: {
...
var index$2 = /*#__PURE__*/memo(function (props) {
  var tabs = props.tabs,
      title = props.title,
  ...
  var tabsReqInit = useRef(null);

  var _useState = useState(tableDataDefault),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var _useState7 = useState(_objectSpread2(_objectSpread2({}, reqDataDefault), requestData)),
  ...
  }, /*#__PURE__*/React.createElement(ProTableHeader, {
    title: title,
    tabs: tabs,
    firstTabsChange: firstTabsChange,
    secondTabsChange: secondTabsChange
  }), props.formProps ? /*#__PURE__*/React.createElement(Form, {
    formProps: props.formProps,
    submit: submit,
    circle: tabs && tabs.secondTabs ? false : true
  }) : null, /*#__PURE__*/React.createElement("div", {
    className: "pro-table-body-wrap"
  }, tableTools && renderTools(tableTools, selectRows), /*#__PURE__*/React.createElement(Table, {
...
var renderTools = function renderTools(tableTools, selectRows) {
  ...
  }, (tableTools === null || tableTools === void 0 ? void 0 : tableTools.title) ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null, tableTools.title)) : null), /*#__PURE__*/React.createElement("div", {
...
export { Form as FSForm, index$2 as FSTable, Form, index as Layout, index$1 as PageContainer, index$2 as ProTable, index$2 as Table };
